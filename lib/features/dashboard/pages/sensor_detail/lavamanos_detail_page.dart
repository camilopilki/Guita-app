...
class LavamanosDetailPage extends StatelessWidget {
  const LavamanosDetailPage({super.key});

  static const _assetMascota = 'assets/images/normal.png';
  static const _assetPanel   = 'assets/images/lava_manos.png';
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 30),
                  const _DataBadge(title: 'ESTA SEMANA', value: '40 L'),
                  SizedBox(height: 16),
                  const _DataBadge(title: 'ESTE MES', value: '180 L'),
                ],
              ),
            ),
          ),
