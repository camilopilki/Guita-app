...
class InodoroDetailPage extends StatelessWidget {
  const InodoroDetailPage({super.key});

  static const _assetMascota = 'assets/images/normal.png';
  static const _assetPanel   = 'assets/images/inodoro.png';
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 30),
                  const _DataBadge(title: 'ESTA SEMANA', value: '80 L'),
                  SizedBox(height: 16),
                  const _DataBadge(title: 'ESTE MES', value: '390 L'),
                ],
              ),
            ),
          ),
...
/* Widgets internos idénticos a los otros */
...
class _DataBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          color: lightBg, borderRadius: BorderRadius.circular(40)),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          Text(title,
